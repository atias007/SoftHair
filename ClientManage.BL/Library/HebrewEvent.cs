...
namespace ClientManage.BL.Library
{
    ...
    {
        תשרי, חשון, כסלו, טבת, שבט, אדר_ב ,אדר, ניסן, אייר, סיון, תמוז, אב, אלול
    }
    ...
    public class HebrewEvent
    {
            ...
            while (startDate.Year == filter.Year.Value && (filter.Month == null || startDate.Month == filter.Month.Value))
            {
                ...
                if (info.IsEvent)
                {
                    var match =
                        ...
                        (filter.IsHolyDate == null || info.IsHolyDate == filter.IsHolyDate.Value) &&
                        (filter.IsHolyDateEvening == null || info.IsHolyDateEvening == filter.IsHolyDateEvening.Value) &&
                        (filter.IsSabaton == null || info.IsSabaton == filter.IsSabaton.Value) &&
        ...
        public static bool IsHolyDate(DateTime date)
        {
            ...
            if (info.IsHolyDate) return true;
            if (info.IsHolyDateEvening || date.DayOfWeek == DayOfWeek.Friday)
            {
                return date.Hour > 16;
            }
            return false;
    ...
    public class HebrewEventInfo
    {
        ...
        /// </summary>
        public HebrewEventInfo() : this(DateTime.Now) { }
        ...
        /// </value>
        public bool IsSabaton { get; private set; }
        ...
        /// </value>
        public bool IsHolyDate { get; private set; }
        ...
        /// </value>
        public bool IsHolyDateEvening { get; private set; }
    ...
    public class HebrewDate
    {
        ...
        /// </summary>
        public HebrewDate() : this(DateTime.Now) { }
