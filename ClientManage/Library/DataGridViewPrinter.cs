...
namespace ClientManage.Library
{
    ...
    {
        private readonly DataGridView TheDataGridView; // The DataGridView Control which will be printed
        private readonly PrintDocument ThePrintDocument; // The PrintDocument to be used for printing
        ...
        private readonly string TheTitleText; // The title text to be printed in each page (if IsWithTitle is set to true)
        private readonly Font TheTitleFont; // The font to be used with the title text (if IsWithTitle is set to true)
        private readonly Color TheTitleColor; // The color to be used with the title text (if IsWithTitle is set to true)
        ...
        public bool DrawDataGridView(Graphics g)
        {
            ...
            {
                throw new Exception("Operation failed: " + ex.Message.ToString());
                //return false;
            }
        }
    }
